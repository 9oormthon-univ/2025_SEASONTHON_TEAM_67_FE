  ...
  const cards = [
    {
      ...
      summary:
        '지난 5년 동안 한국 정부의 의무지출이 약 100조 원 늘었어요. 법이나 제도로 정해져 자동 집행되다 보니 구조적으로 바꾸기 쉽지 않아요.',
      tag: '#법 제정',
    },
    {
      id: '2',
      ...
      summary:
        '정부가 반도체 산업 경쟁력을 높이려고 세액공제를 일정 기간 연장했어요. 기업들의 투자 안정성이 커질 것으로 보여요.',
      tag: '#산업정책',
    },
    {
      id: '3',
      ...
      summary:
        '지역 간 환승 시 불편했던 요금 정산 절차가 간소화돼요. 이용자 편의성과 이동 비용 절감 효과가 기대돼요.',
      tag: '#교통',
    },
    {
      id: '4',
      ...
      summary:
        '정부가 청년층의 주거 부담을 줄이기 위해 월세 지원과 공공임대 물량을 늘렸어요.',
      tag: '#주거',
    },
    {
      id: '5',
      title: '전기차 충전소 확대돼요',
      summary:
        '환경부가 올해 안에 전국 주요 고속도로 휴게소에 급속 충전기를 추가 설치하기로 했어요.',
      tag: '#환경',
    },
    {
      id: '6',
      ...
      summary:
        '정부가 코로나19 이후 시행된 소상공인 카드 수수료 경감 지원을 내년까지 연장한다고 했어요.',
      tag: '#경제',
    },
    {
      id: '7',
      ...
      summary:
        '보건복지부가 지방 의료 공백 해소를 위해 의대 정원을 늘리는 방안을 검토하고 있어요.',
      tag: '#보건',
    },
    {
      id: '8',
      ...
      summary:
        '교육부가 맞벌이 가정을 위해 방과후 돌봄과 예체능 프로그램을 확대 지원하기로 했어요.',
      tag: '#교육',
    },
    {
      id: '9',
      ...
      summary:
        '행정안전부가 기업과 연구자들이 활용할 수 있도록 교통, 환경 데이터를 새로 공개했어요.',
      tag: '#데이터',
    },
    {
      id: '10',
      ...
      summary:
        '방역 당국이 최근 안정세를 고려해 버스, 지하철 등에서 마스크 착용 의무를 해제했어요.',
      tag: '#방역',
    },
  ];
